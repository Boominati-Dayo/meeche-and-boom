...
import { ArrowRight, Sparkles, Zap, Shield, TrendingUp, Clock, Users, Globe, Palette, ShoppingCart, DollarSign, Baby, PawPrint, MapPin, Phone, Building, Edit, Award, ChevronRight, HelpCircle } from "lucide-react";
    ...
    <section ref={ref} className="min-h-screen relative overflow-hidden flex items-center justify-center pt-20 px-3 sm:px-4 md:pt-24 lg:pt-28 pb-12">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center">
          ...
          >
            Specializing in silicone baby stores, pet platforms, tracking systems, e-commerce & custom web solutions. 
        ...
        >
          <div>
            ...
            <p className="text-muted text-base sm:text-lg mb-4">
              BOOMINATI is a digital web development brand focused on creating high-performance websites 
              that drive real business results.
            </p>
            <p className="text-muted text-base sm:text-lg mb-6">
              Specializing in niche e-commerce platforms, logistics/tracking systems, and custom digital solutions. 
              We're not just website builders - we're digital architects who transform businesses through 
              strategic, conversion-optimized web experiences.
            </p>
            ...
            <Link href="/about" className="inline-flex items-center gap-2 mt-6 text-primary hover:underline">
              Learn more <ChevronRight className="w-4 h-4" />
            </Link>
          </div>

          <div className="relative">
            <div className="aspect-square max-w-md mx-auto glass rounded-2xl flex items-center justify-center">
              <div className="text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 mb-8">
          {featured.map((project, idx) => (
            <motion.a
              ...
              className="block group glass rounded-xl overflow-hidden hover:border-primary/50 transition-all"
            >
