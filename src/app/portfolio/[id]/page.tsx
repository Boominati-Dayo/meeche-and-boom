...
import { ArrowLeft, Sparkles, ArrowRight, ExternalLink, ChevronRight, Globe, Shield, TrendingUp, Loader2 } from "lucide-react";
                ...
                <div className="space-y-3">
                  ...
                  {project.technologies && project.technologies.length > 0 && (
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-medium">{project.technologies.join(", ")}</span>
                    </div>
                  )}
                </div>
              </div>
